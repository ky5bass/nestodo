---
inclusion: manual
description: 新しいセッションで GitHub Issue の承認済み内容を読み、既存 spec の更新・新規 spec の作成・既存 spec のアーカイブを行い、spec PR を作成する手順
---
...
19. 変更後に更新・新規作成した各 spec の `requirements.md` と `design.md` がそれぞれ 150 行以内であることを確認する
