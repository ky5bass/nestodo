...
4. 任意フィールドが未指定の場合、Task_Serviceは以下のデフォルト値を設定すること: status=incomplete, progress=null, priority=none（なし）, estimated_time=null, actual_time=null, preview=null, detail_flag=false, export_flag=true
